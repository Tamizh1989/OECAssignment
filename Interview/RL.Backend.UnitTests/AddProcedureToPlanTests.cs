...
public class AddProcedureToPlanTests
{
    ...
    public async Task AddProcedureToPlanTests_InvalidPlanId_ReturnsBadRequest(int planId)
    {
        ...
        var sut = new UpdateProcedureInPlanCommandHandler(context.Object);
        var request = new UpdateProcedureInPlanCommand()
        {
            PlanId = planId,
            ProcedureId = 1
        };
    ...
    public async Task AddProcedureToPlanTests_PlanIdNotFound_ReturnsNotFound(int planId)
    {
        ...
        var sut = new UpdateProcedureInPlanCommandHandler(context);
        var request = new UpdateProcedureInPlanCommand()
        {
            PlanId = planId,
            ProcedureId = 1
